export const projects = [
    {
      ...
      description: "It is a Kanban Board, a visual organization tool, where tasks can be added, filtered, removed, and moved between columns. Each column has a task limit, and if the limit is exceeded, a modal with a message will appear. Tasks can be assigned a color theme, priority, and user. Filtering options are available based on priority and user. The board utilizes Local Storage to store data.",
    ...
    },
    {
      ...
      },
      {
        ...
        stack: ["Typescript", "React", "React-Router", "SCSS"],
